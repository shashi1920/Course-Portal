...
urlpatterns = patterns('',
    ...
    url(r'^programme/(?P<br>[A-Za-z]{2})/(?P<pro>[A-Za-z]+)/(?P<sem>\d+)/courses/$', 'collection.views.COURSES'),
    url(r'^programme/(?P<br>[A-Za-z]{2})/(?P<pro>[A-Za-z]+)/(?P<sem>\d+)/courses/edit/(?P<entry>\d+)/$', 'collection.views.EDIT_COURSES'),
    url(r'^programme/(?P<br>[A-Za-z]{2})/(?P<pro>[A-Za-z]+)/(?P<sem>\d+)/courses/edit/elective/$', 'collection.views.EDIT_ELECTIVE'),
    url(r'^programme/(?P<br>[A-Za-z]{2})/(?P<pro>[A-Za-z]+)/(?P<sem>\d+)/courses/edit/fr/(?P<entry>\d+)/$', 'collection.views.EDIT_FR_COURSES'),
    url(r'^programme/(?P<br>[A-Za-z]{2})/(?P<pro>[A-Za-z]+)/(?P<sem>\d+)/courses/delete/for/(?P<entry>\d+)/$', 'collection.views.DELETE_FR_COURSES'),
    url(r'^programme/(?P<br>[A-Za-z]{2})/(?P<pro>[A-Za-z]+)/(?P<sem>\d+)/lock/$', 'collection.views.LOCK'),
    url(r'^programme/(?P<br>[A-Za-z]{2})/(?P<pro>[A-Za-z]+)/(?P<sem>\d+)/courses/lock/$', 'collection.views.LOCK_COURSES'),
    url(r'^programme/(?P<br>[A-Za-z]{2})/(?P<pro>[A-Za-z]+)/(?P<sem>\d+)/courses/delete/(?P<entry>\d+)/$', 'collection.views.DELETE_COURSES'),
    url(r'^programme/(?P<br>[A-Za-z]{2})/(?P<pro>[A-Za-z]+)/(?P<sem>\d+)/courses/submit/$', 'collection.views.add_course'),
