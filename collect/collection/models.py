...
class Profile(models.Model):
    ...
    level = models.BooleanField() #Level 0 is Professor, Level 1 is for HODs
...
class ProposedCourseList(models.Model):
    ...
    level_0_sign = models.BooleanField()
    level_1_sign = models.BooleanField()
    level_2_sign = models.BooleanField()
...
class ApprovedCourseTeaching(models.Model):
    ...
    elect_or_comp = models.BooleanField()
